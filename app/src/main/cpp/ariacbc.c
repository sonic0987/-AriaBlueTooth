...
Java_com_norma_abc_utils_ARIACBC_processBlock(JNIEnv* env, jobject thiz, jbyteArray inputText, jint nr, jbyteArray rk_, jbyteArray out_,
		jint outputOffset) {
...
JNIEXPORT void JNICALL
Java_com_norma_abc_utils_ARIACBC_ariaEncryptInit(JNIEnv* env, jobject thiz, jbyteArray user_key, jint keyBits, jbyteArray rk_, jintArray nr_) {
...
JNIEXPORT void JNICALL
Java_com_norma_abc_utils_ARIACBC_ariaDecryptInit(JNIEnv* env, jobject thiz, jbyteArray user_key, jint keyBits, jbyteArray rk_, jintArray nr_) {
    jbyte *userkey = (*env)->GetByteArrayElements(env, user_key, 0);
    jbyte *rk = (*env)->GetByteArrayElements(env, rk_, 0);
	jint *nr = (*env)->GetIntArrayElements(env, nr_, 0);
...
Java_com_norma_abc_utils_ARIACBC_internalAriaProcessBlocks(JNIEnv* env, jobject thiz, jbyteArray rk_, jintArray nr_, jbyteArray ivec_,
...
JNIEXPORT jint JNICALL
Java_com_norma_abc_utils_ARIACBC_internalAriaCBCProcessEnc(JNIEnv* env, jobject thiz, jint encrypt, jbyteArray rk_, jintArray nr_,
...
JNIEXPORT jint JNICALL
Java_com_norma_abc_utils_ARIACBC_internalAriaCBCProcessDec(JNIEnv* env, jobject thiz, jint encrypt, jbyteArray rk_, jintArray nr_, jbyteArray ivec_,
