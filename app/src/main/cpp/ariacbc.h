...
JNIEXPORT void JNICALL Java_com_norma_abc_utils_ARIACBC_processBlock(JNIEnv* env, jobject thiz, jbyteArray inputText, jint nr, jbyteArray rk_, jbyteArray out_, jint outputOffset);
JNIEXPORT void JNICALL Java_com_norma_abc_utils_ARIACBC_ariaEncryptInit(JNIEnv* env, jobject thiz, jbyteArray user_key, jint keyBits, jbyteArray rk_, jintArray nr_);
JNIEXPORT void JNICALL Java_com_norma_abc_utils_ARIACBC_ariaDecryptInit(JNIEnv* env, jobject thiz, jbyteArray user_key, jint keyBits, jbyteArray rk_, jintArray nr_);
JNIEXPORT jint JNICALL Java_com_norma_abc_utils_ARIACBC_internalAriaProcessBlocks(JNIEnv* env, jobject thiz, jbyteArray rk_, jintArray nr_, jbyteArray ivec_, jbyteArray cbc_buffer_, jbyteArray outputText, jint outputTextLen);
JNIEXPORT jint JNICALL Java_com_norma_abc_utils_ARIACBC_internalAriaCBCProcessEnc(JNIEnv* env, jobject thiz, jint encrypt, jbyteArray rk_, jintArray nr_, jbyteArray ivec_, jbyteArray cbc_buffer_, jintArray buffer_length_, jbyteArray inputText, jint inputOffset, jint inLen, jbyteArray outputText, jint outputOffset);
JNIEXPORT jint JNICALL Java_com_norma_abc_utils_ARIACBC_internalAriaCBCProcessDec(JNIEnv* env, jobject thiz, jint encrypt, jbyteArray rk_, jintArray nr_, jbyteArray ivec_, jbyteArray cbc_buffer_, jintArray buffer_length_, jbyteArray cbc_last_block_, jintArray last_block_flag_, jbyteArray inputText, jint inputOffset, jint inLen, jbyteArray outputText, jint outputOffset);
